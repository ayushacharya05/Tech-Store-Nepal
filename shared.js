/* ============================================================
   ...
   Handles persistent storage (localStorage) for products, categories,
   and delivery rates so edits made in the dashboard show up on the
   storefront, and stay saved after closing the browser.

   NOTE: localStorage is per-browser, per-origin. For this to sync
   between index.html and dashboard.html, open both from the SAME
   folder on a real web server (or something like `npx serve`) rather
   than double-clicking the files — some browsers isolate file://
   pages from each other even in the same folder.
   ============================================================ */

const STORAGE_KEYS = {
    products: 'techstore_products_v1',
    categories: 'techstore_categories_v1',
    delivery: 'techstore_delivery_v1'
};

/* ---------- Seed data (used only the very first time, before anything is saved) ---------- */
...
const SEED_PRODUCTS = [
    { id: 1, title: 'Ultima Navigator Premium Smartwatch | 1.43" TRU Amoled Spherical Display | In-Build GPS | Barometer | Altimeter | 3 ATM Water Resistance | 24/7 Health Tracking | Fitbeing App Support', brand: 'Ultima', category: 'smartwatch', price: 7499, oldPrice: 11999, rating: 4.5, reviews: 576, sold: '2.4K', badge: 'delivery',
    ...
    { id: 2, title: 'Ultima Watch Circle, 1.43" Amoled Display, Up to 8 Days Battery Life, BT Calling Smartwatch, Ultima Fit App Support, IP68 Water Resistance, 100+ Watch Faces, Zinc Alloy Metal Frame', brand: 'Ultima', category: 'smartwatch', price: 4299, oldPrice: 5499, rating: 4.5, reviews: 1126, sold: '4.1K', badge: 'delivery',
    ...
    { id: 3, title: 'Ultima Watch Flex, 2.01-inch HD Display, Ultima Fit App, Advanced Health', brand: 'Ultima', category: 'smartwatch', price: 2699, oldPrice: 4029, rating: 4.5, reviews: 166, sold: '835', badge: 'delivery',
    ...
    { id: 4, title: 'Ultima Magnum E400 Luxury Smartwatch with 1.43" AMOLED', brand: 'Ultima', category: 'smartwatch', price: 4399, oldPrice: 4582, rating: 4.0, reviews: 374, sold: '996', badge: 'delivery',
    ...
    { id: 5, title: 'Green Airbeat-520 Dual Mic ENC Earbuds | Modern Sleek Design', brand: 'Green', category: 'earbuds', price: 1299, oldPrice: 2598, rating: 4.5, reviews: 3790, sold: '16.2K', badge: 'gems', badgeText: 'Gems save Rs.13',
    ...
    { id: 6, title: 'Ultima Boom 141 ANC Earbuds (30dB) | Ultima Link App Support', brand: 'Ultima', category: 'earbuds', price: 2299, oldPrice: 3483, rating: 4.5, reviews: 5146, sold: '22.1K', badge: 'delivery',
    ...
    { id: 7, title: 'Ultima Atom 192 Pro | App Support | 120H Playtime | Quad Mic', brand: 'Ultima', category: 'earbuds', price: 2099, oldPrice: 2999, rating: 4.5, reviews: 3919, sold: '15.4K', badge: 'delivery',
    ...
    { id: 8, title: 'Ultima Atom Buds 2 Earbuds | Powered by Ultima Supreme Sound', brand: 'Ultima', category: 'earbuds', price: 2499, oldPrice: 3520, rating: 4.0, reviews: 398, sold: '2.3K', badge: 'delivery',
    ...
    { id: 9, title: 'Ultima Boost 20K Mini Powerbank | 22.5W | 20000 mAh | Fast Charging', brand: 'Ultima', category: 'power-banks', price: 3199, oldPrice: 7998, rating: 4.5, reviews: 253, sold: '1.5K', badge: 'delivery',
    ...
    { id: 10, title: 'Ultima Boost 20K Pro 20000mAh Powerbank with 22.5W Display', brand: 'Ultima', category: 'power-banks', price: 2599, oldPrice: 3822, rating: 4.5, reviews: 613, sold: '3.4K', badge: 'delivery',
    ...
    { id: 11, title: 'Green Turbo-20 | 20000mAh Fast Powerbank | 22.5W | PD Fast Charging', brand: 'Green', category: 'power-banks', price: 2399, oldPrice: 3998, rating: 4.5, reviews: 558, sold: '2.7K', badge: 'gems', badgeText: 'Gems save Rs.24',
    ...
    { id: 12, title: 'Mypower Fast Charging Powerbank | 20000mAh | 22.5W PD', brand: 'Mypower', category: 'power-banks', price: 3325, oldPrice: 3500, rating: 4.0, reviews: 620, sold: '2.5K', badge: 'gems', badgeText: 'Gems save Rs.33',
...
/* ---------- Products ---------- */
function loadProducts() { return _loadJSON(STORAGE_KEYS.products, SEED_PRODUCTS); }
function saveProducts(products) { return _saveJSON(STORAGE_KEYS.products, products); }

/* ---------- Categories ---------- */
function loadCategories() { return _loadJSON(STORAGE_KEYS.categories, SEED_CATEGORIES); }
function saveCategories(categories) { return _saveJSON(STORAGE_KEYS.categories, categories); }

/* ---------- Delivery rates ---------- */
function loadDelivery() { return _loadJSON(STORAGE_KEYS.delivery, SEED_DELIVERY); }
function saveDelivery(rates) { return _saveJSON(STORAGE_KEYS.delivery, rates); }
